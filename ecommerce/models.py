...
class Produk(models.Model):
    ...
    deskripsi1 = models.TextField(verbose_name='Deskripsi Atas', default="", blank=True, null=True) # deskripsi atas
    deskripsi2 = models.TextField(verbose_name='Deskripsi Bawah', default="", blank=True, null=True) # deskripsi bawah
    informasi1 = models.TextField(verbose_name='Main Informasi', default="", blank=True, null=True) # informasi
    informasi2 = models.TextField(verbose_name='Bottom Left Informasi', default="", blank=True, null=True) # informasi kiri bawah 
    informasi3 = models.TextField(verbose_name='Bottom Right Informasi', default="", blank=True, null=True) # informasi kanan bawah
